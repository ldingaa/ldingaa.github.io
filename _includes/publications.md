...
<div class="pub-row">
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 1px;">
    ...
    <div class="periodical"><em>IISE Transactions , accepted.</em></div>
<div class="links">
...
<div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left:1px;">
   ...
   <div class="periodical"> <em>Journal of Machine Learning Research, </em> 23 (127), 1-32.</div>
    <div class="links">
      <a href="https://arxiv.org/abs/2010.06802" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
      <a href="[https://github.com/ldingaa](https://github.com/ldingaa/Kernel-Packet)" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">Code</a>
  </div>
...
Covariates: Consistency and Computation</a></div>
   ...
   <div class="periodical"> <em>Naval Research Logistics,</em> 69 (3), 496-507</div>
    <div class="links">
...
<div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left:1px;">
    ...
    <div class="author"><strong>Liang Ding</strong>, Rui, Tuo, Shahin Shahrampour</div>
   <div class="periodical"> <em>International Conference of Machine Learning 2020,</em> 2545-2555</div>
    <div class="links">
      <a href="https://arxiv.org/pdf/1906.05098.pdf" class="btn btn-sm z-depth-0" role="button" target="_blank" style="font-size:12px;">PDF</a>
  </div>
  </div>
